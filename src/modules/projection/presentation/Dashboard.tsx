 ...
 *
 * Módulo: projection
 * Camada: presentation (Dashboard UI)
 */

import React from "react";
import { FixedBill, IncomeSource, CardInvoice, PlannedInstallment } from "../../../types";
import { formatCurrency, formatMonth, addMonths } from "../../../core/shared/formatters";
import { calculateReport } from "../application/reportCalculator";
import { Calendar, CreditCard, ArrowRight, ShieldAlert, CheckCircle2 } from "lucide-react";
